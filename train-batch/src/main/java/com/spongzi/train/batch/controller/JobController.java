package com.spongzi.train.batch.controller;

import com.spongzi.train.batch.req.CronJobReq;
import com.spongzi.train.batch.resp.CronJobResp;
...
public class JobController {
    ...
    public CommonResp add(@RequestBody CronJobReq cronJobReq) {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("创建定时任务失败:调度异常").build();
        } catch (ClassNotFoundException e) {
            LOG.error("创建定时任务失败:" + e);
            return CommonResp.builder().success(false).message("创建定时任务失败：任务类不存在").build();
        }
        LOG.info("创建定时任务结束");
        return CommonResp.builder().build();
    }
    ...
    public CommonResp pause(@RequestBody CronJobReq cronJobReq) {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("暂停定时任务失败:调度异常").build();
        }
        LOG.info("暂停定时任务结束");
        return CommonResp.builder().build();
    }
    ...
    public CommonResp resume(@RequestBody CronJobReq cronJobReq) {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("重启定时任务失败:调度异常").build();
        }
        LOG.info("重启定时任务结束");
        return CommonResp.builder().build();
    }
    ...
    public CommonResp reschedule(@RequestBody CronJobReq cronJobReq) {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("更新定时任务失败:调度异常").build();
        }
        LOG.info("更新定时任务结束");
        return CommonResp.builder().build();
    }
    ...
    public CommonResp delete(@RequestBody CronJobReq cronJobReq) {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("删除定时任务失败:调度异常").build();
        }
        LOG.info("删除定时任务结束");
        return CommonResp.builder().build();
    }
    ...
    public CommonResp query() {
        ...
        try {
            ...
            return CommonResp.builder().success(false).message("查看定时任务失败:调度异常").build();
        }
        LOG.info("查看定时任务结束");
        return CommonResp.builder().content(cronJobDtoList).build();
    }
